...
class ProductoForm(forms.ModelForm):
    # Campo adicional para tipo de producto (no se guarda en Producto, solo se usa para variantes)
    ...
    class Meta:
        ...
        widgets = {
            ...
            'imagen': forms.ClearableFileInput(attrs={'class': 'w-full px-4 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-indigo-500'}),
    ...
    def clean_imagen(self):
        """Permite que el campo imagen sea opcional"""
        imagen = self.cleaned_data.get('imagen')
        # Si no se subió ninguna imagen, devolver None
